...
public class ViewPagerFixed extends FrameLayout {
    ...
    public static class TabsView extends FrameLayout {
        ...
        public TabsView(Context context, boolean hasStableIds, int tabsSelectorType, Theme.ResourcesProvider resourcesProvider) {
            ...
            listView.setSelectorType(viksConfig.tabStyle >= 3 ? 100 : tabsSelectorType);
            if (tabsSelectorType < 3) listView.setSelectorRadius(6);
            listView.setSelectorDrawableColor(viksConfig.tabStyle >= 3 ? 0x00 : Theme.getColor(selectorColorKey, resourcesProvider));
            ...
            if (child == listView) {
                ...
                if (indicatorWidth != 0) {
                    ...
                    selectorDrawable.setBounds(
                            indicatorX - (viksConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : viksConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0),
                            (int) (viksConfig.tabStyle >= 3 ? height / 2 - AndroidUtilities.dp(viksConfig.tabStyle == 3 ? 17 : 18) * (1f - hideProgress) : height - AndroidUtilities.dpr(4) + hideProgress * AndroidUtilities.dpr(4)),
                            indicatorX + indicatorWidth + (viksConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : viksConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0),
                            (int) (viksConfig.tabStyle >= 3 ? height / 2 + AndroidUtilities.dp(viksConfig.tabStyle == 3 ? 17 : 18) * (1f - hideProgress) : height + hideProgress * AndroidUtilities.dpr(4)));
